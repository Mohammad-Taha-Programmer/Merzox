      ...
      builder: (context, state) {
        return Scaffold(
          ...
          bottomNavigationBar: FeatureBottomNavigationBar(
            // The waiting-conversation count belongs to this screen, not to
            // the bar: the bar has no business knowing what a conversation
            // is, so it is handed the badge to hang on the glyph.
            decorateMessages: (Widget glyph) =>
                MessageBadge(businessAudience: false, child: glyph),
