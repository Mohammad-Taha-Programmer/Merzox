...
class _ProfileTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      padding: const EdgeInsets.fromLTRB(16, 18, 16, 118),
      children: [
        const _PlainTabTitle(title: 'حسابي'),
        const SizedBox(height: 20),
        if (isGuest)
          _LoginRequiredPanel(
            ...
            message:
                'سجّل الدخول لتعديل الحساب، إدارة العناوين، الشراء، والدفع.',
            onLoginPressed: onLoginPressed,
          )
        else ...[
          ...
          _ProfileActionTile(
            ...
            title: 'تعديل الحساب',
            subtitle: 'الاسم، أرقام الهاتف، العنوان، ونوع المستخدم',
            onTap: onProtectedAction,
          ),
          _ProfileActionTile(
            icon: Icons.credit_card_rounded,
            title: 'طرق الدفع',
            subtitle: 'بطاقات، نقدا، تحويل بنكي، أو دفع عن مستخدم آخر',
            onTap: onProtectedAction,
          ),
          _ProfileActionTile(
            icon: Icons.psychology_rounded,
            title: 'أذونات الذكاء الاصطناعي والبيانات',
            subtitle: 'إدارة موافقتك على تحليل التفضيلات وتخصيص المتاجر',
            onTap: onProtectedAction,
          ),
          _ProfileActionTile(
            icon: Icons.security_rounded,
            title: 'الخصوصية والأمان',
            subtitle: 'الموقع، جهات الاتصال، وإعدادات حماية الحساب',
            onTap: onProtectedAction,
          ),
          _ProfileActionTile(
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Icon(icon, color: MerzoxColors.kColor3D5A80, size: 30),
          ),
          const SizedBox(height: 14),
          Text(
            title,
...
class _BusinessProfilePage extends StatelessWidget {
  final HomeBusiness business;
  final ValueChanged<int> onNavChanged;

  const _BusinessProfilePage({
    required this.business,
        ...
        child: Stack(
          children: [
            ListView(
              ...
              children: [
                _BusinessProfileTopBar(
                  onBack: () => Navigator.of(context).pop(),
                ),
                const SizedBox(height: 28),
                _BusinessProfileHero(business: business),
                const SizedBox(height: 18),
                Text(
                  business.name,
                  textAlign: TextAlign.center,
            ...
            PositionedDirectional(
              ...
              bottom: 106,
              child: _BusinessChatButton(onPressed: () {}),
            ),
          ],
        ),
      ),
...
class _BusinessProfileHero extends StatelessWidget {
  final HomeBusiness business;

  const _BusinessProfileHero({required this.business});
          ...
          Positioned(
            ...
            child: ClipRRect(
              ...
              child: Container(
                height: 96,
                color: MerzoxColors.kColorEEF6FB,
                child: CustomPaint(painter: _BusinessWavePainter()),
              ),
            ),
          ),
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: DecoratedBox(
                ...
                child: _BusinessProfileLogo(name: business.name),
              ),
            ),
          ),
        ],
...
class _BusinessWavePainter extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    final paint = Paint()
...
class _BusinessProfileLogo extends StatelessWidget {
  final String name;

  const _BusinessProfileLogo({required this.name});
...
class _BusinessProfileStat extends StatelessWidget {
  final String value;
  final String label;
  final IconData icon;

  const _BusinessProfileStat({
    required this.value,
    required this.label,
    required this.icon,
  });
...
class _BusinessProfileTabDivider extends StatelessWidget {
  const _BusinessProfileTabDivider();
...
class _BusinessServices extends StatelessWidget {
  final List<String> products;

  const _BusinessServices({required this.products});
...
class _BusinessChatButton extends StatelessWidget {
  final VoidCallback onPressed;

  const _BusinessChatButton({required this.onPressed});
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Icon(Icons.verified_rounded, color: MerzoxColors.kColorEE6C4D),
        ],
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(icon, size: 20, color: MerzoxColors.kColorEE6C4D),
          const SizedBox(height: 5),
          Text(
            value,
          ...
          Text(
            ...
            maxLines: 1,
            overflow: TextOverflow.ellipsis,
            style: TextStyle(fontSize: 11, color: MerzoxColors.kColor767676),
          ),
        ],
      ),
    );
      ...
      child: ListTile(
        ...
        title: Text(
          ...
          style: TextStyle(
            fontSize: 14,
            fontWeight: FontWeight.w800,
            color: destructive ? color : const Color(0xFF2B2B2B),
          ),
        ),
        subtitle: Text(
          subtitle,
