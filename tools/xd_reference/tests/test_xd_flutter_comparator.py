    ...
    def test_real_mapping_file_matches_its_locked_entries(self) -> None:
        ...
        self.assertEqual(
            ...
            [
                ...
                (
                    "favorites",
                    "test/goldens/seed/favorites_products_ar_375x812.png",
                    "المفضلة",
                    "9df0ef98-a4a4-418c-a2d0-c8171cf03c19",
                    "artwork/artboard-8c14fb74-98d8-4e38-b0f7-0f7b7ba3805c",
                    375,
                    810,
                    "extend_final_row_to_812",
                ),
                (
                    "store_details",
                    "test/goldens/seed/store_details_customer_ar_375x812.png",
                    "تفاصيل المتجر – 1",
                    "749086a1-b2c8-4d36-b23d-5961376e5911",
                    "artwork/artboard-94914543-915f-4653-af97-285b87ebcdfb",
                    375,
                    810,
                    "extend_final_row_to_812",
                ),
                ...
                (
                    "product_details",
                    "test/goldens/seed/product_details_ar_375x812.png",
                    "تفاصيل المتجر – 8",
                    "4b0b3ac3-0022-4de2-a0e5-756601280607",
                    "artwork/artboard-cde06fe1-416a-421b-94cb-cd280aa1056a",
                    375,
                    800,
                    "extend_final_row_to_812",
                ),
                (
                    "checkout_buyer",
                    "test/goldens/seed/checkout_buyer_ar_375x812.png",
                    "تفاصيل المتجر – 16",
                    "6220e04a-82bd-42fb-8fb6-b194f1e212a6",
                    "artwork/artboard-3212cea6-6eac-4c2b-92d4-fc25f3c5fc04",
                    375,
                    808,
                    "extend_final_row_to_812",
                ),
                (
                    "checkout_payment",
                    "test/goldens/seed/checkout_payment_ar_375x812.png",
                    "تفاصيل المتجر – 26",
                    "3eb04ace-b8df-4450-b3a7-dc3d64580ad8",
                    "artwork/artboard-7e490ee6-c7bb-4ee5-9bb7-0b5c6620cd50",
                    375,
                    808,
                    "extend_final_row_to_812",
                ),
                ...
                (
                    "messages_inbox",
                    "test/goldens/seed/messages_inbox_ar_375x812.png",
                    "الرسائل – 4",
                    "bdbe6b50-5093-4d15-9e14-c3aec8821e2d",
                    "artwork/artboard-2c2fafd3-b228-4e8a-99bc-9a366839092f",
                    375,
                    810,
                    "extend_final_row_to_812",
                ),
                (
                    "messages_empty",
                    "test/goldens/seed/messages_empty_ar_375x812.png",
                    "الرسائل",
                    "9a36e5d5-79fa-4d67-a19a-d24abb6652c9",
                    "artwork/artboard-f0930cf3-1088-4cc0-b844-23ea1df2230b",
                    375,
                    812,
                    "exact",
                ),
                (
                    "notifications",
                    "test/goldens/seed/notifications_ar_375x812.png",
                    "الرسائل – 5",
                    "d753df9e-964a-4b98-9031-514ecf513efc",
                    "artwork/artboard-e8d050b5-eac3-4f9e-a0ca-842e4b25e508",
                    375,
                    810,
                    "extend_final_row_to_812",
                ),
                (
                    "checkout_done",
                    "test/goldens/seed/checkout_done_ar_375x812.png",
                    "تفاصيل المتجر – 17",
                    "79fbe6cf-c0c1-4334-8f73-d12771d63c7b",
                    "artwork/artboard-dba6cf14-27cd-47e0-a3be-a4963b18bf96",
                    375,
                    808,
                    "extend_final_row_to_812",
                ),
                (
                    "search_history",
                    "test/goldens/seed/search_history_ar_375x812.png",
                    "البحث",
                    "88eb7e0d-5581-462d-bf65-1e9a187adff1",
                    "artwork/artboard-9533152e-bb79-4567-8432-729e77a5e023",
                    375,
                    810,
                    "extend_final_row_to_812",
                ),
                (
                    "search_products",
                    "test/goldens/seed/search_products_ar_375x812.png",
                    "بحث منتجات",
                    "ae2906ae-bb0b-45f6-b4db-7ea6d52ccd44",
                    "artwork/artboard-8ee8ca5f-413b-4b22-88a6-a66584b9e13d",
                    375,
                    810,
                    "extend_final_row_to_812",
                ),
                (
                    "search_stores",
                    "test/goldens/seed/search_stores_ar_375x812.png",
                    "بحث متاجر",
                    "6553f38c-e202-4b21-862d-618382dbd840",
                    "artwork/artboard-197919fa-9f91-40f2-ab11-2f6f6d3cecc8",
                    375,
                    810,
                    "extend_final_row_to_812",
                ),
                (
                    "profile_guest",
                    "test/goldens/seed/profile_guest_ar_375x812.png",
                    "البروفايل – 1",
                    "6158e2a9-6c0a-4339-a56d-48c8ba2ba108",
                    "artwork/artboard-b5c6bd68-f048-4631-bae6-44610335a099",
                    375,
                    1075,
                    "crop_top_to_812",
                ),
                (
                    "profile_merchant",
                    "test/goldens/seed/profile_merchant_ar_375x812.png",
                    "البروفايل",
                    "e5d63064-d49b-4cc9-a5a1-2053cb24300c",
                    "artwork/artboard-6cc95e16-8971-4d50-ae3f-542d59d0201e",
                    375,
                    914,
                    "crop_top_to_812",
                ),
                (
                    "profile_form",
                    "test/goldens/seed/profile_form_ar_375x812.png",
                    "تعديل الملف الشخصي",
                    "d8998c46-d85a-4d14-ac6e-97c05d25666f",
                    "artwork/artboard-6636840c-df3a-4c10-8a2f-d4f4a74452d3",
                    375,
                    810,
                    "extend_final_row_to_812",
                ),
                (
                    "store_settings",
                    "test/goldens/seed/store_settings_ar_375x812.png",
                    "اعدادات المتجر",
                    "3de9948d-4451-4604-8df7-3e0ad9131c33",
                    "artwork/artboard-5b3bc09f-9c9c-4d4f-b7d5-339b777d0163",
                    375,
                    807,
                    "extend_final_row_to_812",
                ),
                (
                    "orders_current",
                    "test/goldens/seed/orders_current_ar_375x812.png",
                    "تفاصيل المتجر – 22",
                    "00fc6554-9bab-48fc-b8e5-489dfe7a8bd7",
                    "artwork/artboard-c023e977-cbd8-46cd-96e2-cbfc73686812",
                    375,
                    808,
                    "extend_final_row_to_812",
                ),
                (
                    "orders_completed",
                    "test/goldens/seed/orders_completed_ar_375x812.png",
                    "تفاصيل المتجر – 19",
                    "ef447a75-53a1-4d3c-9005-7357605d2e8b",
                    "artwork/artboard-516a509b-3b66-48cf-b19f-56264eacce6e",
                    375,
                    808,
                    "extend_final_row_to_812",
                ),
                (
                    "orders_cancelled",
                    "test/goldens/seed/orders_cancelled_ar_375x812.png",
                    "تفاصيل المتجر – 23",
                    "34f26b42-ea88-4537-8295-afd91400184d",
                    "artwork/artboard-6f540fc1-797c-49d6-ac59-525f45c91472",
                    375,
                    808,
                    "extend_final_row_to_812",
                ),
                (
                    "orders_empty",
                    "test/goldens/seed/orders_empty_ar_375x812.png",
                    "السلة – 4",
                    "735d3a5c-dcc8-4b1e-811f-85995ae388ea",
                    "artwork/artboard-5c73099e-976f-4302-aaac-7b3d6054ac04",
                    375,
                    812,
                    "exact",
                ),
                (
                    "add_product",
                    "test/goldens/seed/add_product_ar_375x812.png",
                    "إضافة منتجات",
                    "2a394bd3-6aeb-46c2-afda-a1daddd6f168",
                    "artwork/artboard-6712b392-dfa0-4ed5-bf54-05ff139e5f61",
                    375,
                    1334,
                    "crop_top_to_812",
                ),
                (
                    "add_product_ticked",
                    "test/goldens/seed/add_product_ticked_ar_375x812.png",
                    "إضافة منتجات – 1",
                    "b2c5f0c2-0331-45e9-946e-f569c9613c13",
                    "artwork/artboard-eb2c1d36-4549-4de8-ba74-b04047a024fd",
                    375,
                    1334,
                    "crop_top_to_812",
                ),
                (
                    "add_product_options",
                    "test/goldens/seed/add_product_options_ar_375x812.png",
                    "إضافة منتجات – 2",
                    "8f8d98d3-9baf-4022-949b-aabe4a8b3787",
                    "artwork/artboard-92a3d46f-b20e-4914-801c-3c5d8bc01ead",
                    375,
                    1251,
                    "crop_top_to_812",
                ),
                (
                    ...
                    "test/goldens/seed/merchant_order_detail_ar_375x812.png",
                    "تفاصيل الطلب",
                    "a32801f2-9040-44e7-9b96-c70292b895a1",
                    "artwork/artboard-7516e705-d2df-40d0-b0d4-9123b034baae",
                    375,
                    808,
                    "extend_final_row_to_812",
                ),
                (
                    "merchant_order_status_menu",
                    "test/goldens/seed/merchant_order_status_menu_ar_375x812.png",
                    "تفاصيل الطلب – 1",
                    "97eec35d-b20f-4b41-941b-b7618cc70707",
                    "artwork/artboard-255ea64d-f256-445e-95cb-cde1a183583b",
                    375,
                    808,
                    "extend_final_row_to_812",
                ),
                (
                    "merchant_order_notified",
                    "test/goldens/seed/merchant_order_notified_ar_375x812.png",
                    "تفاصيل الطلب – 2",
                    "7951c97c-80fc-4d15-b687-30c6c19b24f2",
                    "artwork/artboard-a26e2eb5-3be8-47f8-b48c-8ca0332cd8f4",
                    375,
                    808,
                    "extend_final_row_to_812",
                ),
                (
                    ...
                    "test/goldens/seed/merchant_order_invoice_ar_375x812.png",
                    "تفاصيل الطلب – 3",
                    "cb71b94e-cef4-4fb6-b10c-00d497cd6314",
                    "artwork/artboard-aeed8791-0e43-4abe-a9e9-8d39dde8b469",
                    375,
                    808,
                    "extend_final_row_to_812",
                ),
                (
                    "product_reviews",
                    "test/goldens/seed/product_reviews_ar_375x812.png",
                    "تفاصيل المتجر – 34",
                    "5bd79c1d-2b07-44d1-9129-7f607e1ccb19",
                    "artwork/artboard-bf5395a7-0329-4b1c-99c8-ce5846814955",
                    375,
                    1141,
                    "crop_top_to_812",
                ),
                (
                    ...
                    "test/goldens/seed/checkout_address_form_ar_375x812.png",
                    "تفاصيل المتجر – 29",
                    "eba6e283-2353-474e-96bf-f25f28d094ed",
                    "artwork/artboard-0eb623e2-3c12-4811-998f-22dfdd2389e2",
                    375,
                    808,
                    "extend_final_row_to_812",
                ),
                (
                    ...
                    "test/goldens/seed/checkout_governorate_ar_375x812.png",
                    "تفاصيل المتجر – 28",
                    "b02e7d19-5da7-4163-839f-d035e9a8f1d9",
                    "artwork/artboard-754206ac-0ccc-4dd4-b275-6285e97917cf",
                    375,
                    808,
                    "extend_final_row_to_812",
                ),
                (
                    "checkout_city",
                    "test/goldens/seed/checkout_city_ar_375x812.png",
                    "تفاصيل المتجر – 27",
                    "143b4f12-eea3-4cad-abe6-474a7f5bc2e5",
                    "artwork/artboard-2d0f2946-4360-4413-9f1b-b1bffd353f64",
                    375,
                    808,
                    "extend_final_row_to_812",
                ),
                ...
                (
                    "store_settings_logo",
                    "test/goldens/seed/store_settings_logo_ar_375x812.png",
                    "\u0627\u0639\u062f\u0627\u062f\u0627\u062a \u0627\u0644\u0645\u062a\u062c\u0631 - \u0634\u0639\u0627\u0631 \u0627\u0644\u0645\u062a\u062c\u0631",
                    "d646b5a6-99f2-4644-9c77-f6e42e765b1e",
                    "artwork/artboard-87cd75ab-7e7e-4ffb-9569-c10a6146fbe4",
                    375,
                    807,
                    "extend_final_row_to_812",
                ),
                (
                    ...
                    "test/goldens/seed/store_settings_description_ar_375x812.png",
                    "\u0627\u0639\u062f\u0627\u062f\u0627\u062a \u0627\u0644\u0645\u062a\u062c\u0631 - \u0648\u0635\u0641 \u0627\u0644\u0645\u062a\u062c\u0631",
                    "81568c5b-ec51-4df3-8428-a68136285e3d",
                    "artwork/artboard-905116f1-8b5c-48cd-a6a9-2faf8263f422",
                    375,
                    807,
                    "extend_final_row_to_812",
                ),
                (
                    "store_settings_social",
                    "test/goldens/seed/store_settings_social_ar_375x812.png",
                    "\u0627\u0639\u062f\u0627\u062f\u0627\u062a \u0627\u0644\u0645\u062a\u062c\u0631 - \u0648\u0633\u0627\u0626\u0644 \u0627\u0644\u062a\u0648\u0627\u0635\u0644",
                    "2b28f335-37af-4fa6-95bf-82f516000c2a",
                    "artwork/artboard-4b6abcf8-435c-4345-ba4e-58ff90b54aa2",
                    375,
                    807,
                    "extend_final_row_to_812",
                ),
                (
                    "onboarding_map",
                    "test/goldens/seed/onboarding_map_ar_375x812.png",
                    "\u0634\u0627\u0634\u0629 \u062a\u0631\u062d\u064a\u0628\u064a\u0629 1",
                    "d8deb8c1-c164-464b-b92c-bc31b3d75eac",
                    "artwork/artboard-e262a484-4490-4c6d-bff9-9c2bfae8bb25",
                    375,
                    812,
                    "exact",
                ),
                (
                    "onboarding_payment",
                    "test/goldens/seed/onboarding_payment_ar_375x812.png",
                    "\u0634\u0627\u0634\u0629 \u062a\u0631\u062d\u064a\u0628\u064a\u0629 1 \u2013 1",
                    "601edd36-30cf-4789-80ff-8b67edf0efc7",
                    "artwork/artboard-81eeef77-7f0e-4a18-8d18-d360845a00c5",
                    375,
                    812,
                    "exact",
                ),
                (
                    "cart_loaded",
                    "test/goldens/seed/cart_loaded_ar_375x812.png",
                    "\u0627\u0644\u0633\u0644\u0629 \u2013 1",
                    "93493ac9-a4be-4ea7-92c6-45b228672803",
                    "artwork/artboard-d0374c1a-d767-4c91-acee-1bfffcc6c094",
                    375,
                    808,
                    "extend_final_row_to_812",
                ),
                (
                    "cart_empty",
                    "test/goldens/seed/cart_empty_ar_375x812.png",
                    "\u0627\u0644\u0633\u0644\u0629 \u2013 2",
                    "72c484ac-8b51-4123-ac08-f1a17b79c35c",
                    "artwork/artboard-723c33b3-b5d4-4f11-b035-c3995e9c7ea1",
                    375,
                    812,
                    "exact",
                ),
                (
                    "favorites_stores",
                    "test/goldens/seed/favorites_stores_ar_375x812.png",
                    "\u0627\u0644\u0645\u0641\u0636\u0644\u0629 \u2013 1",
                    "68fa2ab9-9f72-4475-90a9-63dc8bd00193",
                    "artwork/artboard-688ee249-8507-4499-9def-adb6c148fb67",
                    375,
                    810,
                    "extend_final_row_to_812",
                ),
                (
                    "order_tracking_preparing",
                    "test/goldens/seed/order_tracking_preparing_ar_375x812.png",
                    "\u062a\u062a\u0628\u0639 \u0627\u0644\u0637\u0644\u0628 \u2013 1",
                    "9aec45e7-c76a-49c8-b30a-30ca27cf7ef0",
                    "artwork/artboard-b3a89251-8e39-4383-81ef-a65308d69363",
                    375,
                    812,
                    "exact",
                ),
                (
                    "order_tracking_on_the_way",
                    "test/goldens/seed/order_tracking_on_the_way_ar_375x812.png",
                    "\u062a\u062a\u0628\u0639 \u0627\u0644\u0637\u0644\u0628 \u2013 2",
                    "b7428d33-5579-48af-9c54-23de5eb84632",
                    "artwork/artboard-bf1fbfb6-8407-4e87-9863-89f1bc628d2a",
                    375,
                    812,
                    "exact",
                ),
                (
                    "order_tracking_review",
                    "test/goldens/seed/order_tracking_review_ar_375x812.png",
                    "\u062a\u0642\u064a\u064a\u0645",
                    "5edaa160-6cd5-4ae6-9d2c-efa4cfdf3b9c",
                    "artwork/artboard-9a5befdd-fefd-4154-ac08-dc41812c5bb0",
                    375,
                    812,
                    "exact",
                ),
                (
                    "enrollment_account",
                    "test/goldens/seed/enrollment_account_ar_375x812.png",
                    "\u0625\u0646\u0634\u0627\u0621 \u062d\u0633\u0627\u0628 \u2013 1",
                    "0cd698d9-9369-4093-8b35-f27498ba4560",
                    "artwork/artboard-b91e8299-9746-4e9a-8d81-7c708846c814",
                    375,
                    812,
                    "exact",
                ),
                (
                    "enrollment_store",
                    "test/goldens/seed/enrollment_store_ar_375x812.png",
                    "\u0625\u0646\u0634\u0627\u0621 \u062d\u0633\u0627\u0628 \u2013 2",
                    "b00426f9-36c9-4174-8fe0-36e61ec33e59",
                    "artwork/artboard-e479bb29-1971-4be0-8b89-629ad96e51ae",
                    375,
                    986,
                    "crop_top_to_812",
                ),
                (
                    "messages_gate",
                    "test/goldens/seed/messages_gate_ar_375x812.png",
                    "\u0627\u0644\u0631\u0633\u0627\u0626\u0644 \u2013 1",
                    "564e1f27-bbb1-435c-8979-9dad96f50719",
                    "artwork/artboard-3611cfde-6a3e-4585-914c-2f3352ecd66e",
                    375,
                    812,
                    "exact",
                ),
                (
                    "messages_unread",
                    "test/goldens/seed/messages_unread_ar_375x812.png",
                    "\u0627\u0644\u0631\u0633\u0627\u0626\u0644",
                    "2181a84f-83ec-461a-984e-d95b5e9a1fe5",
                    "artwork/artboard-428a0849-f6b7-4dec-bf98-884042e3d229",
                    375,
                    810,
                    "extend_final_row_to_812",
                ),
                (
                    "chat_customer",
                    "test/goldens/seed/chat_customer_ar_375x812.png",
                    "\u0627\u0644\u0631\u0633\u0627\u0626\u0644 \u2013 2",
                    "be534a86-cd28-466c-ab2b-69f6945494d1",
                    "artwork/artboard-be72caa1-2792-4c91-b0e8-32630f9c10da",
                    375,
                    810,
                    "extend_final_row_to_812",
                ),
                (
                    "chat_merchant",
                    "test/goldens/seed/chat_merchant_ar_375x812.png",
                    "\u0627\u0644\u0631\u0633\u0627\u0626\u0644",
                    "9db2c0ee-7a4f-4f68-befd-33e26951a58d",
                    "artwork/artboard-a7385d90-932c-4978-bdc4-ce522ab3c1c5",
                    375,
                    810,
                    "extend_final_row_to_812",
                ),
                (
                    ...
                    "test/goldens/seed/merchant_order_filter_ar_375x812.png",
                    "\u0627\u0644\u0631\u0626\u064a\u0633\u064a\u0629 \u2013 12",
                    "47a7e81f-cd9a-41a8-8d19-f2f92a263e0f",
                    "artwork/artboard-beec9796-17f3-48ec-bb5c-9b74a1365522",
                    375,
                    808,
                    "extend_final_row_to_812",
                ),
                (
                    "merchant_product_menu",
                    "test/goldens/seed/merchant_product_menu_ar_375x812.png",
                    "\u0627\u0644\u0631\u0626\u064a\u0633\u064a\u0629 \u2013 13",
                    "88b38d89-3dec-433d-9d76-c2a52d727ca7",
                    "artwork/artboard-f72f1e4b-bae1-4439-9ea5-ad83fbd4b20a",
                    375,
                    808,
                    "extend_final_row_to_812",
                ),
                (
                    "merchant_product_filter",
                    "test/goldens/seed/merchant_product_filter_ar_375x812.png",
                    "\u0627\u0644\u0631\u0626\u064a\u0633\u064a\u0629 \u2013 16",
                    "94b228cf-ae93-42f6-9264-6c61e0337d20",
                    "artwork/artboard-26470fcb-ac25-47b7-9087-401627a1b8bb",
                    375,
                    808,
                    "extend_final_row_to_812",
                ),
                (
                    ...
                    "test/goldens/seed/merchant_product_images_ar_375x812.png",
                    "\u0627\u0644\u0631\u0626\u064a\u0633\u064a\u0629 \u2013 14",
                    "99b9e7b0-ec6e-49bf-9282-ec29f2793cc3",
                    "artwork/artboard-434bb904-38e9-48de-bbbb-d02b8da24f02",
                    375,
                    1009,
                    "crop_top_to_812",
                ),
                (
                    "store_settings_closed",
                    "test/goldens/seed/store_settings_closed_ar_375x812.png",
                    "\u0627\u0639\u062f\u0627\u062f\u0627\u062a \u0627\u0644\u0645\u062a\u062c\u0631",
                    "4c608328-df08-4187-ae3a-9d849332167a",
                    "artwork/artboard-0c361447-1919-45e7-a177-a5baa10f9401",
                    375,
                    807,
                    "extend_final_row_to_812",
                ),
                (
                    "chat_empty",
                    "test/goldens/seed/chat_empty_ar_375x812.png",
                    "\u062a\u0641\u0627\u0635\u064a\u0644 \u0627\u0644\u0645\u062a\u062c\u0631 \u2013 18",
                    "b81ea3ec-9c49-4b2f-b386-d3a04cab8d62",
                    "artwork/artboard-ea9279d7-1a37-4839-b5e9-c43c335c1c83",
                    375,
                    805,
                    "extend_final_row_to_812",
                ),
                (
                    "chat_storefront",
                    "test/goldens/seed/chat_storefront_ar_375x812.png",
                    "\u062a\u0641\u0627\u0635\u064a\u0644 \u0627\u0644\u0645\u062a\u062c\u0631 \u2013 20",
                    "f279de6a-80b5-4f99-b5f1-db80a20ea94a",
                    "artwork/artboard-912a5591-8704-4951-902f-7fd9c17fb286",
                    375,
                    805,
                    "extend_final_row_to_812",
                ),
                (
                    "checkout_cancel",
                    "test/goldens/seed/checkout_cancel_ar_375x812.png",
                    "\u062a\u0641\u0627\u0635\u064a\u0644 \u0627\u0644\u0645\u062a\u062c\u0631 \u2013 30",
                    "b4af8a63-e4d2-44fa-9f9b-09f8e7482422",
                    "artwork/artboard-c3cebb35-cca9-4bca-99f3-1e65ec0eee0d",
                    375,
                    808,
                    "extend_final_row_to_812",
                ),
